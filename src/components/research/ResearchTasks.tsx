...
const INITIAL_TASKS: ResearchTask[] = [
  { id: 't1', title: 'Research Nuclear Non-Proliferation Treaty', description: 'Compile a comprehensive brief on the NPT, its history, key provisions, and current challenges. Focus on recent developments in nuclear disarmament.', assignee: 'Elena Vasquez', dueDate: '2025-03-15', status: 'IN_PROGRESS', priority: 'HIGH', createdAt: '2025-02-20' },
  { id: 't2', title: 'Country Profile: Federal Republic of Nigeria', description: 'Create a detailed country profile covering Nigeria\'s foreign policy, UN voting record, key alliances, and stance on Security Council reform.', assignee: 'Amara Okafor', dueDate: '2025-03-10', status: 'IN_PROGRESS', priority: 'MEDIUM', createdAt: '2025-02-18' },
  { id: 't3', title: 'Climate Action Resolution Draft', description: 'Draft a model resolution on climate action for the General Assembly session, referencing the Paris Agreement and recent COP outcomes.', assignee: 'Lucas Schmidt', dueDate: '2025-03-20', status: 'PENDING', priority: 'HIGH', createdAt: '2025-02-22' },
  { id: 't4', title: 'Security Council Reform Analysis', description: 'Analyze proposals for Security Council reform, including expansion of permanent and non-permanent membership, and veto power modifications.', assignee: 'Kai Nakamura', dueDate: '2025-03-25', status: 'PENDING', priority: 'MEDIUM', createdAt: '2025-02-25' },
  { id: 't5', title: 'Position Paper: Global Trade Equity', description: 'Write a position paper on global trade equity for ECOSOC discussions, focusing on developing nations\' perspectives.', assignee: 'Priya Sharma', dueDate: '2025-03-05', status: 'COMPLETED', priority: 'MEDIUM', createdAt: '2025-02-10' },
  { id: 't6', title: 'Map UN Sustainable Development Goals Progress', description: 'Create a visual map tracking SDG progress across regions with key statistics and case studies.', assignee: 'Fatima Al-Rashid', dueDate: '2025-03-12', status: 'IN_PROGRESS', priority: 'LOW', createdAt: '2025-02-15' },
  { id: 't7', title: 'Historical Crisis Committee Brief', description: 'Prepare background guides for the historical crisis committee simulation on the Suez Crisis of 1956.', assignee: 'Oliver Brooks', dueDate: '2025-04-01', status: 'PENDING', priority: 'HIGH', createdAt: '2025-02-28' },
  { id: 't8', title: 'Delegate Preparation Guide - Rules of Procedure', description: 'Update the delegate preparation guide with the latest Robert\'s Rules of Order modifications used in MUN sessions.', assignee: 'Sofia Costa', dueDate: '2025-03-08', status: 'COMPLETED', priority: 'LOW', createdAt: '2025-02-05' },
  { id: 't9', title: 'Research Humanitarian Intervention Framework', description: 'Compile research on R2P (Responsibility to Protect) doctrine and its application in recent humanitarian crises.', assignee: 'Chen Wei', dueDate: '2025-03-18', status: 'PENDING', priority: 'MEDIUM', createdAt: '2025-02-26' },
]
